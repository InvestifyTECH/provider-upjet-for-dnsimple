...
PROJECT_NAME ?= provider-upjet-for-dnsimple
...
export TERRAFORM_PROVIDER_SOURCE ?= dnsimple/dnsimple
export TERRAFORM_PROVIDER_REPO ?= https://github.com/dnsimple/terraform-provider-dnsimple
export TERRAFORM_PROVIDER_VERSION ?= 0.16.3
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-dnsimple
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://github.com/dnsimple/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/releases/download/v$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-dnsimple_v0.16.3
...
xpkg.build.provider-upjet-for-dnsimple: do.build.images
